...
<form action="SubmitJob" method="post">
  <div class="container">
    ...
    <input type="text"  name="Cname"  value="<%=request.getAttribute("Jcompany")%>" readonly><br>
    
     <label ><b>Job Title</b></label>
    <input type="text"  name="Jpost" value="<%=request.getAttribute("Jtitle")%>" readonly><br>
    
    <label for="email"><b>Email</b></label>
    <input type="text" name="email" value="<%=session.getAttribute("username")%>" readonly><br>
