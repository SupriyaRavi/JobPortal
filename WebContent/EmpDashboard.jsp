<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<%@page import="JobPortal.DAO.SqlOperation"%>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="row content">
			<div class="col-sm-2 sidenav">
				...
				<form action="Jobs" method="post">
					<a class="two" href="ApplyJobs">Job Search</a>
				</form>
				</p>
				<p>
			...
			<div class="col-sm-8 text-left">
				...
				int percent=SqlOperation.ProfileCompleteStatusUser(name);
				...
				%>
				<p> <b>Profile Complete Status <%=(float)request.getAttribute("status") %>
